...
Source: `src/agents/workspace.ts:23-31` (file list), `src/agents/pi-embedded-helpers/bootstrap.ts:84,162-191` (injection), `src/memory/qmd-manager.ts:324-329` (QMD validation)
