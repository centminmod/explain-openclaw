...
5. **`ade11ec89`** — Idempotency strengthening: Deterministic idempotency keys (`src/agents/announce-idempotency.ts:10-12`) prevent duplicate subagent invocations via race conditions.
