...
1. **`ee519086f`** — **NEW FEATURE** Default messenger delivery target.
   - `src/config/zod-schema.providers-core.ts:116` — `defaultTo` in `TelegramAccountSchemaBase`
   - `src/config/zod-schema.providers-core.ts:325` — `defaultTo` in `DiscordAccountSchema`
