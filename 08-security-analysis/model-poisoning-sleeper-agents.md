...
- Code ref: `src/agents/models-config.providers.ts:77-86` — Ollama configured as HTTP endpoint
...
| RBAC enforcement | `src/gateway/server-methods.ts:99-169` | Prevents agent self-approval |
