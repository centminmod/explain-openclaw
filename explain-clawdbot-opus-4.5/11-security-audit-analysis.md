...
- **`28b78b25b`** — **Persist bootstrap onboarding state:** New workspace-state.json tracking via `resolveWorkspaceStatePath()` at `src/agents/workspace.ts:172`, `readWorkspaceOnboardingState()` at `:197-215`, `writeWorkspaceOnboardingState()` at `:228-242`. Causes +122 line shift (plus Feb 20 sync 5 +29): `loadWorkspaceBootstrapFiles()` now at `441-495`, `filterBootstrapFilesForSession()` now at `499-507`.
